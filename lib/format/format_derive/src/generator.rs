...
impl FormatImplGenerator {
    ...
    fn add_primitive_type(
        ...
        let (from_bytes, to_bytes) =
            endianness_from_to(field_settings.endianness.unwrap_or(Endianness::Native));
    ...
    fn add_generic_array_type(
        ...
        let sub_field_settings = FieldSettings {
            endianness,
            padding: None,
        };
